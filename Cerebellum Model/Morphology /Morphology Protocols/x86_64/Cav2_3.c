...
static void _check_mhn(double*, Datum*, Datum*, _NrnThread*); 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Cav2_3 /Users/tylerrivera/Honors Project 2022/Honors-Project-2022/Cerebellum Model/Morphology /Morphology Protocols/Mod Files/Cav2_3.mod\n");
...
static void _hoc_vartau(void) {
 ...
 static double _mfac_mhn, _tmin_mhn;
  static void _check_mhn(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {
 ...
 static int mhn(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _lv) { 
#if 0
_check_mhn(_p, _ppvar, _thread, _nt);
#endif
 ...
 static void _n_mhn(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _lv){ int _i, _j;
 double _xi, _theta;
 if (!usetable) {
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/tylerrivera/Honors Project 2022/Honors-Project-2022/Cerebellum Model/Morphology /Morphology Protocols/Mod Files/Cav2_3.mod";
static const char* nmodl_file_text = 
