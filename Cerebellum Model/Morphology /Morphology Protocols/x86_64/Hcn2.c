...
#define _f_rate _f_rate__HCN2 
#define rate rate__HCN2 
#define state state__HCN2 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "o_inf_HCN2", _hoc_o_inf,
 "r_HCN2", _hoc_r,
 "rate_HCN2", _hoc_rate,
 "tau_slow_HCN2", _hoc_tau_slow,
 "tau_fast_HCN2", _hoc_tau_fast,
 0, 0
};
#define o_inf o_inf_HCN2
#define r r_HCN2
#define tau_slow tau_slow_HCN2
#define tau_fast tau_fast_HCN2
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 HCN2 /Users/tylerrivera/Honors Project 2022/Honors-Project-2022/Cerebellum Model/Morphology /Morphology Protocols/Mod Files/Hcn2.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/tylerrivera/Honors Project 2022/Honors-Project-2022/Cerebellum Model/Morphology /Morphology Protocols/Mod Files/Hcn2.mod";
static const char* nmodl_file_text = 
