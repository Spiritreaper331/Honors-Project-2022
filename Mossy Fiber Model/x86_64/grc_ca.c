...
#define nrn_init _nrn_init__GrC_CaHVA
#define _nrn_initial _nrn_initial__GrC_CaHVA
#define nrn_cur _nrn_cur__GrC_CaHVA
#define _nrn_current _nrn_current__GrC_CaHVA
#define nrn_jacob _nrn_jacob__GrC_CaHVA
#define nrn_state _nrn_state__GrC_CaHVA
#define _net_receive _net_receive__GrC_CaHVA 
#define _f_rate _f_rate__GrC_CaHVA 
#define rate rate__GrC_CaHVA 
#define states states__GrC_CaHVA 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_GrC_CaHVA", _hoc_setdata,
 "alp_u_GrC_CaHVA", _hoc_alp_u,
 "alp_s_GrC_CaHVA", _hoc_alp_s,
 "bet_u_GrC_CaHVA", _hoc_bet_u,
 "bet_s_GrC_CaHVA", _hoc_bet_s,
 "rate_GrC_CaHVA", _hoc_rate,
 0, 0
};
#define alp_u alp_u_GrC_CaHVA
#define alp_s alp_s_GrC_CaHVA
#define bet_u bet_u_GrC_CaHVA
#define bet_s bet_s_GrC_CaHVA
...
#define usetable usetable_GrC_CaHVA
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_GrC_CaHVA", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "Aalpha_s_GrC_CaHVA", "/ms",
 "Kalpha_s_GrC_CaHVA", "mV",
 "V0alpha_s_GrC_CaHVA", "mV",
 "Abeta_s_GrC_CaHVA", "/ms",
 "Kbeta_s_GrC_CaHVA", "mV",
 "V0beta_s_GrC_CaHVA", "mV",
 "Aalpha_u_GrC_CaHVA", "/ms",
 "Kalpha_u_GrC_CaHVA", "mV",
 "V0alpha_u_GrC_CaHVA", "mV",
 "Abeta_u_GrC_CaHVA", "/ms",
 "Kbeta_u_GrC_CaHVA", "mV",
 "V0beta_u_GrC_CaHVA", "mV",
 "gcabar_GrC_CaHVA", "mho/cm2",
 "ica_GrC_CaHVA", "mA/cm2",
 "tau_s_GrC_CaHVA", "ms",
 "tau_u_GrC_CaHVA", "ms",
 "g_GrC_CaHVA", "mho/cm2",
 "alpha_s_GrC_CaHVA", "/ms",
 "beta_s_GrC_CaHVA", "/ms",
 "alpha_u_GrC_CaHVA", "/ms",
 "beta_u_GrC_CaHVA", "/ms",
 0,0
};
 ...
 "usetable_GrC_CaHVA", &usetable_GrC_CaHVA,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 GrC_CaHVA /Users/tylerrivera/Honors Project 2022/Honors-Project-2022/Mossy Fiber Model/grc_ca.mod\n");
...
static int _reset;
static char *modelname = "Cerebellum Granule Cell Model, CaHVA channel";
...
double alp_s ( _threadargsprotocomma_ double _lv ) {
 ...
 _lQ10 = pow( 3.0 , ( ( celsius - 20.0 ) / 10.0 ) ) ;
   if ( ( _lv - V0alpha_s ) / Kalpha_s > 200.0 ) {
     _lalp_s = _lQ10 * Aalpha_s * exp ( 200.0 ) ;
     }
   else {
...
double bet_s ( _threadargsprotocomma_ double _lv ) {
 ...
 _lQ10 = pow( 3.0 , ( ( celsius - 20.0 ) / 10.0 ) ) ;
   if ( ( _lv - V0beta_s ) / Kbeta_s > 200.0 ) {
     _lbet_s = _lQ10 * Abeta_s * exp ( 200.0 ) ;
     }
   else {
...
double alp_u ( _threadargsprotocomma_ double _lv ) {
 ...
 double _lQ10 ;
 _lQ10 = pow( 3.0 , ( ( celsius - 20.0 ) / 10.0 ) ) ;
   if ( ( _lv - V0alpha_u ) / Kalpha_u > 200.0 ) {
     _lalp_u = _lQ10 * Aalpha_u * exp ( 200.0 ) ;
     }
   else {
...
double bet_u ( _threadargsprotocomma_ double _lv ) {
 ...
 double _lQ10 ;
 _lQ10 = pow( 3.0 , ( ( celsius - 20.0 ) / 10.0 ) ) ;
   if ( ( _lv - V0beta_u ) / Kbeta_u > 200.0 ) {
     _lbet_u = _lQ10 * Abeta_u * exp ( 200.0 ) ;
     }
   else {
...
static void _initlists(){
 ...
 _slist2[0] = &(s) - _p;
 _slist2[1] = &(u) - _p;
   _t_s_inf = makevector(201*sizeof(double));
   _t_tau_s = makevector(201*sizeof(double));
   _t_u_inf = makevector(201*sizeof(double));
   _t_tau_u = makevector(201*sizeof(double));
_first = 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/tylerrivera/Honors Project 2022/Honors-Project-2022/Mossy Fiber Model/grc_ca.mod";
static const char* nmodl_file_text = 
