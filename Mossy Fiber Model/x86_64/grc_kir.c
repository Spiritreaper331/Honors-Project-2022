...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 GrC_Kir /Users/tylerrivera/Honors Project 2022/Honors-Project-2022/Mossy Fiber Model/grc_kir.mod\n");
...
static int _reset;
static char *modelname = "Cerebellum Granule Cell Model, Kir channel";
...
double alp_d ( _threadargsprotocomma_ double _lv ) {
 ...
 _lQ10 = pow( 3.0 , ( ( celsius - 20.0 ) / 10.0 ) ) ;
   if ( ( _lv - V0alpha_d ) / Kalpha_d > 200.0 ) {
     _lalp_d = _lQ10 * Aalpha_d * exp ( 200.0 ) ;
     }
   else {
...
double bet_d ( _threadargsprotocomma_ double _lv ) {
 ...
 double _lQ10 ;
 _lQ10 = pow( 3.0 , ( ( celsius - 20.0 ) / 10.0 ) ) ;
   if ( ( _lv - V0beta_d ) / Kbeta_d > 200.0 ) {
     _lbet_d = _lQ10 * Abeta_d * exp ( 200.0 ) ;
     }
   else {
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/tylerrivera/Honors Project 2022/Honors-Project-2022/Mossy Fiber Model/grc_kir.mod";
static const char* nmodl_file_text = 
