...
#define nrn_init _nrn_init__GrG_KM
#define _nrn_initial _nrn_initial__GrG_KM
#define nrn_cur _nrn_cur__GrG_KM
#define _nrn_current _nrn_current__GrG_KM
#define nrn_jacob _nrn_jacob__GrG_KM
#define nrn_state _nrn_state__GrG_KM
#define _net_receive _net_receive__GrG_KM 
#define _f_rate _f_rate__GrG_KM 
#define rate rate__GrG_KM 
#define states states__GrG_KM 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_GrG_KM", _hoc_setdata,
 "alp_n_GrG_KM", _hoc_alp_n,
 "bet_n_GrG_KM", _hoc_bet_n,
 "rate_GrG_KM", _hoc_rate,
 0, 0
};
#define alp_n alp_n_GrG_KM
#define bet_n bet_n_GrG_KM
...
#define usetable usetable_GrG_KM
 double usetable = 1;
 ...
 "usetable_GrG_KM", &usetable_GrG_KM,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 GrG_KM /Users/tylerrivera/Honors Project 2022/Honors-Project-2022/Mossy Fiber Model/grg_km.mod\n");
...
static int _reset;
static char *modelname = "Cerebellum Granule Cell Model, KM channel";
...
double alp_n ( _threadargsprotocomma_ double _lv ) {
 ...
 _lQ10 = pow( 3.0 , ( ( celsius - 22.0 ) / 10.0 ) ) ;
   if ( ( _lv - V0alpha_n ) / Kalpha_n > 200.0 ) {
     _lalp_n = _lQ10 * Aalpha_n * exp ( 200.0 ) ;
     }
   else {
...
double bet_n ( _threadargsprotocomma_ double _lv ) {
 ...
 double _lQ10 ;
 _lQ10 = pow( 3.0 , ( ( celsius - 22.0 ) / 10.0 ) ) ;
   if ( ( _lv - V0beta_n ) / Kbeta_n > 200.0 ) {
     _lbet_n = _lQ10 * Abeta_n * exp ( 200.0 ) ;
     }
   else {
...
static int  _f_rate ( _threadargsprotocomma_ double _lv ) {
 ...
 _la_n = alp_n ( _threadargscomma_ _lv ) ;
   ...
   if ( ( - ( _lv - V0_ninf ) / B_ninf ) > 200.0 ) {
     n_inf = 1.0 / ( 1.0 + exp ( 200.0 ) ) ;
     }
   else {
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/tylerrivera/Honors Project 2022/Honors-Project-2022/Mossy Fiber Model/grg_km.mod";
static const char* nmodl_file_text = 
