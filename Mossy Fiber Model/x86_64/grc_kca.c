...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 GrC_KCa /Users/tylerrivera/Honors Project 2022/Honors-Project-2022/Mossy Fiber Model/grc_kca.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Cerebellum Granule Cell Model, KCa channel";
...
double alp_c ( _threadargsprotocomma_ double _lv ) {
 ...
 _lQ10 = pow( 3.0 , ( ( celsius - 30.0 ) / 10.0 ) ) ;
   if ( _lv / Kalpha_c > 200.0 ) {
     _lalp_c = _lQ10 * Aalpha_c / ( 1.0 + ( Balpha_c * exp ( 200.0 ) / cai ) ) ;
     }
   else {
...
double bet_c ( _threadargsprotocomma_ double _lv ) {
 ...
 double _lQ10 ;
 _lQ10 = pow( 3.0 , ( ( celsius - 30.0 ) / 10.0 ) ) ;
   if ( _lv / Kbeta_c > 200.0 ) {
     _lbet_c = _lQ10 * Abeta_c / ( 1.0 + cai / ( Bbeta_c * exp ( 200.0 ) ) ) ;
     }
   else {
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/tylerrivera/Honors Project 2022/Honors-Project-2022/Mossy Fiber Model/grc_kca.mod";
static const char* nmodl_file_text = 
