...
#define nrn_init _nrn_init__GrG_KV
#define _nrn_initial _nrn_initial__GrG_KV
#define nrn_cur _nrn_cur__GrG_KV
#define _nrn_current _nrn_current__GrG_KV
#define nrn_jacob _nrn_jacob__GrG_KV
#define nrn_state _nrn_state__GrG_KV
#define _net_receive _net_receive__GrG_KV 
#define _f_rate _f_rate__GrG_KV 
#define rate rate__GrG_KV 
#define states states__GrG_KV 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_GrG_KV", _hoc_setdata,
 "alp_n_GrG_KV", _hoc_alp_n,
 "bet_n_GrG_KV", _hoc_bet_n,
 "linoid_GrG_KV", _hoc_linoid,
 "rate_GrG_KV", _hoc_rate,
 0, 0
};
#define alp_n alp_n_GrG_KV
#define bet_n bet_n_GrG_KV
#define linoid linoid_GrG_KV
...
#define usetable usetable_GrG_KV
 double usetable = 1;
 ...
 "Aalpha_n_GrG_KV", "/ms-mV",
 "Kalpha_n_GrG_KV", "mV",
 "V0alpha_n_GrG_KV", "mV",
 "Abeta_n_GrG_KV", "/ms",
 "Kbeta_n_GrG_KV", "mV",
 "V0beta_n_GrG_KV", "mV",
 "gkbar_GrG_KV", "mho/cm2",
 "ik_GrG_KV", "mA/cm2",
 "tau_n_GrG_KV", "ms",
 "g_GrG_KV", "mho/cm2",
 "alpha_n_GrG_KV", "/ms",
 ...
 "usetable_GrG_KV", &usetable_GrG_KV,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 GrG_KV /Users/tylerrivera/Honors Project 2022/Honors-Project-2022/Mossy Fiber Model/grg_kv.mod\n");
...
static int _reset;
static char *modelname = "Cerebellum Granule Cell Model, KDr channel";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/tylerrivera/Honors Project 2022/Honors-Project-2022/Mossy Fiber Model/grg_kv.mod";
static const char* nmodl_file_text = 
